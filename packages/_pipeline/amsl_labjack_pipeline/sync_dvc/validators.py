...
import amsl_labjack_pipeline
from amsl_labjack_pipeline import sync_dvc
from amsl_labjack_pipeline.sync_dvc.contexts import DVC
from amsl_labjack_pipeline.sync_dvc.dvc import OutFlags, Stage
from amsl_labjack_pipeline.sync_dvc.types import DvcValidationInfo, Model
...
def dvc_prepare_stage(
    ...
    dvc.stage.cmd = sep.join([
        f"./Invoke-Uv {amsl_labjack_pipeline.__name__.replace('_', '-')}",
