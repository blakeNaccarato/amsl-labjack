...
AmslLabJackPipelineConfigDict: TypeAlias = PluginConfigDict[
    ContextPluginSettings["AmslLabJackPipelineContexts"]
]
AmslLabJackPipelineValidationInfo: TypeAlias = ContextValidationInfo[
    "AmslLabJackPipelineContexts"
]
AmslLabJackPipelineSerializationInfo: TypeAlias = ContextSerializationInfo[
    "AmslLabJackPipelineContexts"
]
