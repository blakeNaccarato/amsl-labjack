...
from amsl_labjack_pipeline.models.generated.types.stages import StageName
...
class Paths(AmslLabJackPipelineContextStore):
    """Pipeline paths."""

    model_config = get_amsl_labjack_pipeline_config(track_kinds=True)
